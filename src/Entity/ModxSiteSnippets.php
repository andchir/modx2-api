 ...
 * ModxSiteSnippets
 *
 * @ORM\Table(name="modx_site_snippets", uniqueConstraints={@ORM\UniqueConstraint(name="name", columns={"name"})}, indexes={@ORM\Index(name="category", columns={"category"}), @ORM\Index(name="moduleguid", columns={"moduleguid"}), @ORM\Index(name="locked", columns={"locked"}), @ORM\Index(name="static", columns={"static"})})
 * @ORM\Entity
 */
class ModxSiteSnippets
{
    /**
     * @var int
     *
