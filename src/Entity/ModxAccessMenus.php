 ...
 * ModxAccessMenus
 *
 * @ORM\Table(name="modx_access_menus", indexes={@ORM\Index(name="principal", columns={"principal"}), @ORM\Index(name="policy", columns={"policy"}), @ORM\Index(name="target", columns={"target"}), @ORM\Index(name="authority", columns={"authority"}), @ORM\Index(name="principal_class", columns={"principal_class"})})
 * @ORM\Entity
 */
class ModxAccessMenus
{
    /**
     * @var int
     *
