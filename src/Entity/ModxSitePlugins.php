 ...
 * ModxSitePlugins
 *
 * @ORM\Table(name="modx_site_plugins", uniqueConstraints={@ORM\UniqueConstraint(name="name", columns={"name"})}, indexes={@ORM\Index(name="category", columns={"category"}), @ORM\Index(name="disabled", columns={"disabled"}), @ORM\Index(name="locked", columns={"locked"}), @ORM\Index(name="static", columns={"static"})})
 * @ORM\Entity
 */
class ModxSitePlugins
{
    /**
     * @var int
     *
     ...
     * @var string
     *
     * @ORM\Column(name="plugincode", type="text", length=16777215, nullable=false)
     */
    private $plugincode;
     ...
     * @var string
     *
     * @ORM\Column(name="moduleguid", type="string", length=32, nullable=false)
     */
    private $moduleguid = '';
