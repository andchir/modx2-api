...
/**
 * ModxUserGroupSettings
 *
 * @ORM\Table(name="modx_user_group_settings")
 * @ORM\Entity
 */
class ModxUserGroupSettings
{
    /**
     * @var int
     *
     * @ORM\Column(name="group", type="integer", nullable=false, options={"unsigned"=true})
     * @ORM\Id
